...
class Agent(object):
    ...
    def action_train(self):
        self.n_steps += 1
        value_multi, action_env_multi, entropy, log_prob, (self.hxs, self.cxs) = self.model(
    ...
    def optimize(self, params, optimizer, shared_model, device_share):
        ...
        loss = (policy_loss[0] + 0.5 * value_loss[0]).mean()
